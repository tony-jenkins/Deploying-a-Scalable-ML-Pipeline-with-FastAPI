...
def main():
    ...
    # Train / test split
    train, test = train_test_split(df, test_size=0.2, random_state=42, stratify=df["salary"])
    ...
    print(f"Overall metrics -> precision: {precision:.4f}, recall: {recall:.4f}, fbeta: {fbeta:.4f}")
